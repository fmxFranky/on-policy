...
policies = {
    ...
    'baseline_consumer': (ConsumerBaselinePolicy, env.observation_space,
                          ...
                          BaselinePolicy.get_config_from_env(env)),
    'ppo_store_consumer':
        (MyTFPolicy, env.observation_space, env.action_space_consumer,
         ppo_policy_config_store_consumer),
}
...
parser.add_argument(
    ...
    type=str,
    default=
    '/root/ray_results/PPO_InventoryManageEnv_2020-12-08_11-16-1828rcclo9/checkpoint_160/checkpoint-160'
)
