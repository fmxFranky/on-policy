...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_obs_agent(self, agent_id):
        ...
        if unit.health > 0:  # otherwise dead, return all zeros
            ...
            for e_id, e_unit in self.enemies.items():
                ...
                if (dist < sight_range and
                        e_unit.health > 0):  # visible and alive
            ...
            for i, al_id in enumerate(al_ids):
                ...
                if (dist < sight_range and
                        al_unit.health > 0):  # visible and alive
        ...
        if (self.use_mustalive and unit.health > 0) or (
            ...
            for al_id, al_unit in self.agents.items():
                if al_unit.health > 0:
                    ...
                    if (self.map_type == "MMM" and
                            al_unit.unit_type == self.medivac_id):
    ...
    def get_obs_size(self):
        ...
        return [
            ...
            [n_allies, n_ally_feats], [n_enemies,
                                       n_enemy_feats], [1, move_feats],
    ...
    def get_state_size(self):
        ...
        if self.use_state_agent:
            ...
            return [
                ...
                [1,
                 move_feats], [1, own_feats + agent_id_feats + timestep_feats]
            ]
