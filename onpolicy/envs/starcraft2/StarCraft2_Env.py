...
class StarCraft2Env(MultiAgentEnv):
  ...
  def step(self, actions):
    ...
    try:
      ...
      return local_obs, global_state, [[
          0
      ]] * self.n_agents, dones, infos, available_actions
  ...
  def get_obs_agent(self, agent_id):
    ...
    agent_obs = np.concatenate((ally_feats.flatten(), enemy_feats.flatten(),
  ...
  def get_state(self, agent_id=-1):
    ...
    if (self.use_mustalive and
        unit.health > 0) or (not self.use_mustalive):  # or else all zeros
      # Movement features
      for m in range(self.n_actions_move):
      ...
      for al_id, al_unit in self.agents.items():
        if al_unit.health > 0:
          ...
          if (self.map_type == "MMM" and al_unit.unit_type == self.medivac_id):
            ...
            ally_state[al_id,
                       1] = (al_unit.weapon_cooldown / max_cd)  # cooldown
          ...
          if self.add_center_xy:
            ...
            ally_state[al_id, ind +
                       1] = (al_y - center_y) / self.max_distance_y  # center Y
            ind += 2
          ...
          if unit.health > 0:
            ...
            if self.add_xy_state:
              ...
              ally_state[al_id,
                         ind + 1] = (al_y - y) / sight_range  # relative Y
              ind += 2
            if self.add_visible_state:
              if dist < sight_range:
        ...
        if e_unit.health > 0:
          ...
          if self.add_center_xy:
            ...
            enemy_state[e_id, ind +
                        1] = (e_y - center_y) / self.max_distance_y  # center Y
            ind += 2
          ...
          if unit.health > 0:
            ...
            if self.add_visible_state:
              ...
              ind += 1
            if self.add_enemy_action_state:
              enemy_state[e_id, ind] = avail_actions[self.n_actions_no_attack +
                                                     e_id]  # available
  ...
  def get_obs_size(self):
    ...
    return [
        ...
        [n_allies, n_ally_feats], [n_enemies, n_enemy_feats], [1, move_feats],
  ...
  def get_state_size(self):
    ...
    return [
        ...
        [self.n_agents, nf_al], [self.n_enemies, nf_en],
